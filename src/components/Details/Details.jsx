...
const Details = () => {
    ...
    return (
        <div className='font-inter w-[95%] lg:w-[85%] lg:max-w-7xl mx-auto pt-2 md:pt-10 md:pb-24'>
            <div className="flex flex-col lg:flex-row h-auto lg:h-[420px] rounded-md md:rounded-2xl bg-[#ffb94944] shadow-xl mb-8 hover:shadow-2xl transform hover:scale-105 transition-all duration-500">
