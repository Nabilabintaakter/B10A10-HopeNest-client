        ...
        <div>
            ...
            >
                    ...
                    <div
                        ...
                        <div className="hero-content text-neutral-content text-center">
                            <div className="text-white">
                                <h1 className="font-libre w-full mb-5 text-3xl md:text-5xl font-bold max-w-5xl">EMPOWER EDUCATION FOR ALL</h1>
                                <p className="mb-5 font-sans max-w-3xl mx-auto">
                ...
                <SwiperSlide><div
                    ...
                    <div className="hero-content text-neutral-content text-center">
                        <div className="text-white">
                            <h1 className="font-libre w-full mb-5 text-3xl md:text-5xl font-bold max-w-5xl">SUPPORT DISASTER RELIEF EFFORTS"</h1>
                            <p className="mb-5 font-sans max-w-3xl mx-auto">
                ...
                <SwiperSlide>
                    <div
                        ...
                        <div className="hero-content text-neutral-content text-center">
                            <div className="text-white">
                                <h1 className="font-libre w-full mb-5 text-3xl md:text-5xl font-bold max-w-5xl">JOIN HANDS FOR A HEALTHIER TOMORROW</h1>
                                <p className="mb-5 font-sans max-w-3xl mx-auto">
