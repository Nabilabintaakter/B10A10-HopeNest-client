...
const Login = () => {
    ...
    const { handleLogin, setUser, handleGoogleSignIn, setLoading ,dark} = useContext(AuthContext);
    ...
    return (
        <div className="bg-gray-50 dark:bg-gradient-to-tr dark:from-gray-900 dark:to-gray-700">
            <div className="font-sans pt-6 pb-10 lg:pt-10 lg:pb-20 flex flex-col items-center min-h-screen ">
                <div className="text-center mb-8 px-4">
                    <p className=" text-2xl lg:text-3xl font-semibold text-gray-800 dark:text-white mb-2">Log in to HopeNest to make an impact!</p>
                    <p className="text-lg lg:text-xl text-gray-600 dark:text-gray-400">Please enter your credentials to continue.</p>
                </div>
